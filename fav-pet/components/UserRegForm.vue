    ...
    <div>
            ...
            <div class="flex flex-col md:flex-row">
                <div class="w-full md:w-5/12 md:ml-2">
                    ...
                    <div class="mb-6">
                        ...
                        <input v-model="email" class="form-input w-full text-black" type="email" name="email"
                            id="registration_email" placeholder="Your email" spellcheck="false" autocomplete="email"
                        ...
                        <div class="relative">
                            ...
                            <template v-else>
                                <svg @click="handleImageClick" xmlns="http://www.w3.org/2000/svg" width="160"
                                    ...
                                    class="bi bi-camera border border-cyan-900 p-5 ml-20 dark:border-white hover:bg-amber-500 cursor-pointer"
                                    viewBox="0 0 16 16">
                                    <path
                            ...
                            <input type="file" ref="imageInput" hidden
                                accept="image/png, image/jpeg, image/jpg, image/svg, video/mp4" @change="handleImageChange">
                        </div>
                    </div>
        ...
        <section class="md:w-3/4 md:ml-auto mb-6 flex text-center">
            <div>
                ...
                <br>
                <p class="text-center">
                    By registering you agree to our <a href="/rules" class="text-lowercase">rules</a>, <a href="/terms"
                        class="text-lowercase">terms</a>, and <a href="/privacy" class="text-lowercase">privacy
                        policy</a>.
                </p>
            </div>
        </section>
